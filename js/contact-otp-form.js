 ...
 * 2. Page on *.onrender.com (same app serves API) → same origin (empty base)
 * 3. Node dev server on this host, port 3000 → same origin (empty base)
 * 4. Otherwise → production Render API (e.g. Vercel → Render)
 */
(function () {
  "use strict";
